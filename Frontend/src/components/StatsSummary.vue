...
<template>
  <section class="summary-grid" aria-label="统计摘要">
    <article class="summary-card"><span>最高 Rating</span><strong>{{ summary.maxRating ?? '--' }}</strong></article>
    <article class="summary-card"><span>平均 Rating</span><strong>{{ summary.averageRating ?? '--' }}</strong></article>
    <article class="summary-card"><span>1900+ 人数</span><strong>{{ summary.count1900Plus }}</strong></article>
    <article class="summary-card"><span>1600+ 人数</span><strong>{{ summary.count1600Plus }}</strong></article>
